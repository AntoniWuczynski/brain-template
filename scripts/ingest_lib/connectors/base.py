...
class ConnectorError(RuntimeError):
    """A connector cannot complete its pull at all (missing credentials,
    unreachable or refusing source). ``scripts/pull.py`` maps it to a clean
    one-line stderr message and exit 2, like ``TranscriptSourceError``."""
